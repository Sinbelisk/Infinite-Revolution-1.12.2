...
mods.avaritia.ExtremeCrafting.addShaped("infiniteFlowerCraft", <botania:specialflower>.withTag({type: "asgardandelion"}),
[
    [null, null, null, <botania:storage:2>, <botania:storage:2>, <botania:storage:2>, null, null, null],
    
    [null, null, <botania:storage:2>, <botania:storage:3>, <botania:storage:1>, <botania:storage:3>, <botania:storage:2>, null, null],

    [null, null, <botania:storage:2>, <botania:storage:1>, <avaritia:resource:5>, <botania:storage:1>, <botania:storage:2>, null, null],

    [null, null, <botania:storage:2>, <botania:storage:3>, <botania:storage:1>, <botania:storage:3>, <botania:storage:2>, null, null],

    [null, null, null, <botania:storage:2>, <botania:storage:2>, <botania:storage:2>, null, null, null],

    [null, <avaritia:resource:4>, <avaritia:resource:4>, null, <avaritia:block_resource>, null, <avaritia:resource:4>, <avaritia:resource:4>, null],

    [<avaritia:resource:4>, <avaritia:resource:3>, <avaritia:resource:3>, <avaritia:resource:4>, <avaritia:block_resource>, <avaritia:resource:4>, <avaritia:resource:3>, <avaritia:resource:3>, <avaritia:resource:4>],
...
mods.avaritia.ExtremeCrafting.addShaped("newPoteInfinitoCraft", <extrautils2:drum:4>,
[
    [null, null, <mysticalagradditions:storage:1>, <avaritia:resource:6>, <mysticalagradditions:storage:1>, <avaritia:resource:6>, <mysticalagradditions:storage:1>, null, null],
    
    [null, <mysticalagradditions:storage:1>, <extraplanets:tier10_items:3>, <botania:blackholetalisman>, <botania:blackholetalisman>, <botania:blackholetalisman>, <extraplanets:tier10_items:3>, <mysticalagradditions:storage:1>, null],

    [null, <extraplanets:tier10_items:3>, <avaritia:block_resource>, <botania:blackholetalisman>, <botania:blackholetalisman>, <botania:blackholetalisman>, <avaritia:block_resource>, <extraplanets:tier10_items:3>, null],

    [null, <mysticalagradditions:storage:1>, <avaritia:resource:4>, <botania:blackholetalisman>, <avaritia:resource:6>, <botania:blackholetalisman>, <avaritia:resource:4>, <mysticalagradditions:storage:1>, null],

    [null, <avaritia:resource:6>, <avaritia:block_resource>, <avaritia:resource:6>, <extrautils2:drum:3>, <avaritia:resource:6>, <avaritia:block_resource>, <avaritia:resource:6>, null],
...
// Add extreme craft Infinite Fluid Storage Disk
mods.avaritia.ExtremeCrafting.addShaped("creativeFluidDisk", <refinedstorage:fluid_storage_disk:4>,
[
    [null, null, null, null, null, null, null, null, null],
    
    [null, null, null, null, <avaritia:block_resource>, null, null, null, null],

    [null, null, null, <refinedstorage:quartz_enriched_iron_block>, <rebornstorage:storagepart:7>, <refinedstorage:quartz_enriched_iron_block>, null, null, null],

    [null, null, <refinedstorage:quartz_enriched_iron_block>, <refined_avaritia:extreme_pattern>, <rebornstorage:storagepart:7>, <refined_avaritia:extreme_pattern>, <refinedstorage:quartz_enriched_iron_block>, null, null],

    [null, <avaritia:block_resource>, <rebornstorage:storagepart:7>, <rebornstorage:storagepart:7>, <avaritia:resource:5>, <rebornstorage:storagepart:7>, <rebornstorage:storagepart:7>, <avaritia:block_resource>, null],
